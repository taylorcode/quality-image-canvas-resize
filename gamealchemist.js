 ...
 *
 * @description
 * Creates an image canvas, uses downScaleCanvas to downscale the image canvas, 
 * uses native toBlob or polyfill to convert the canvas data into a blob.
 *
 ...
 * @returns {Object} Nothing useful because it relies on a callback. TODO(Taylor) return a promise.
 */
 ...
 *
 * @description
 * Resizes a canvas using a high quality algorithm, originally created by gamealchemist.
 *
